...
import com.seck.hzy.lorameterapp.LoRaApp.utils.Z_SelectionMode;
 ...
 *
 */
public class Z_FileDialog extends ListActivity {
	...
	private int selectionMode = Z_SelectionMode.MODE_CREATE;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.z_activity_file_dialog_main);
		...
		selectionMode = getIntent().getIntExtra(SELECTION_MODE, Z_SelectionMode.MODE_CREATE);
	...
	private void getDirImpl(final String dirPath) {
		...
		if (!currentPath.equals(ROOT)) {
			...
			item.add(ROOT);
			addItem(ROOT, R.drawable.pic_folder);
			path.add(ROOT);

			item.add("../");
			addItem("../", R.drawable.pic_folder);
		...
		for (String dir : dirsMap.tailMap("").values()) {
			addItem(dir, R.drawable.pic_folder);
		}

		for (String file : filesMap.tailMap("").values()) {
			addItem(file, R.drawable.pic_file);
		}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (file.isDirectory()) {
			...
			if (file.canRead()) {
				...
				new AlertDialog.Builder(this).setIcon(R.drawable.pic_icon)
