package com.seck.hzy.lorameterapp.LoRaApp.barcode;
...
import com.seck.hzy.lorameterapp.LoRaApp.utils.LoRa_LightControl;
...
public class CaptureActivity extends Activity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lora_camera_diy);
	...
	protected void onResume() {
		...
		btn_light_control.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				LoRa_LightControl mLightControl = new LoRa_LightControl();
...
//			System.out.println("Result:"+resultString);
	...
	private void playBeepSoundAndVibrate() {
		if (playBeep && mediaPlayer != null) {  //提示音
			mediaPlayer.start();
		}
		if (vibrate) {   //振动
